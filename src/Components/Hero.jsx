          ...
          <div className="flex flex-1 w-full px-14 bg-slate-50">
            ...
            >
              ...
              <Link to="/WholeProducts">
                <button className="w-48 py-3 mt-10 text-white transition-all bg-black border border-black rounded-full hover:outline-none hover:border hover:border-white duration-400 font-Manrope hover:bg-white hover:text-black hover:shadow-buttonShadow">
                  Shop Now
                </button>
              </Link>
              <div className="flex justify-center flex-grow gap-4 px-4 py-3 my-10">
