...
aspect-square w-10 flex justify-center items-center text-yellow-700"
  ...
  return (
    <div className="flex flex-col items-start justify-start w-full h-screen gap-10 p-10 mb-20 bg-slate-50">
      <div className="text-xl text-black pagination font-Manrope">
        <Link to={"/"} className="hover:text-blue-900">
          Home
        </Link>{" "}
        &gt;{" "}
        <Link to={"/WomensClothing"} className="hover:text-blue-900">
          Women's Clothing
        </Link>
      </div>
